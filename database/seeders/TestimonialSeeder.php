...
class TestimonialSeeder extends Seeder
{
    public function run(): void
    {
        $testimonials = [
            ...
            ['name' => 'Vikram Singh', 'service' => 'PPF Installation', 'rating' => 5, 'review' => 'PPF on the front bumper and bonnet saved my paint within the first month of driving in Punjab traffic. Invisible protection and flawless installation.', 'is_featured' => true],
