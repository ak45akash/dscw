@php
    ...
    $address = $business['address'] ?? '123 Premium Auto Lane, Mumbai, Maharashtra 400001';
@endphp
...
<footer class="bg-gray-900 text-white">
    <div class="container-custom py-16">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
                <h3 class="mb-4 text-xl font-bold">Diamond Steam Car Wash</h3>
                <p class="mb-4 text-gray-400">
                    Providing premium car wash and detailing services in {{ $city }}.
                </p>
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-gray-400 transition-colors hover:text-white" aria-label="Instagram">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold">Our Services</h3>
                <ul class="space-y-2">
            ...
            <div>
                ...
                <address class="not-italic">
                    <p class="mb-2 flex items-start text-gray-400">
                        <svg class="mr-2 mt-1 h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        {{ $address }}
                    </p>
                    <p class="mb-2 flex items-start text-gray-400">
                    ...
                    <p class="flex items-start text-gray-400">
                        <svg class="mr-2 mt-1 h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        {{ $email }}
                    </p>
                </address>
            </div>
    ...
    <div class="border-t border-gray-800">
        <div class="container-custom flex flex-col items-center justify-between py-6 md:flex-row">
            ...
            <div class="mt-4 flex items-center space-x-6 md:mt-0">
                ...
                <a href="https://iakash.dev" target="_blank" rel="noopener noreferrer" class="flex items-center text-sm text-gray-400 transition-colors hover:text-white">
                    ...
                    <span class="ml-1 font-semibold text-blue-400 hover:text-blue-300">ak45</span>
                </a>
            </div>
        </div>
    </div>
